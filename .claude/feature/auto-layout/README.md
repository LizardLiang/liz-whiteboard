...
## Overview
Automatically position ER diagram tables so the most related tables are placed near each other, triggered by a manual "Auto Layout" button in the diagram UI.
...
## History
- 2026-05-01T18:11:08+08:00: Feature created by Kratos
