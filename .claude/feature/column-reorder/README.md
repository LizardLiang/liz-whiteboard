...
Drag-and-drop reordering of columns (fields) within a table node in the ER whiteboard, with persistence to the database and real-time sync across collaborators.
...
- 2026-04-30: Feature created by Kratos
